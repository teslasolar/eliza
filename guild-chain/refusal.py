...
class RetaliationPattern:
    ...
    refusal_id: int
    pattern_type: str       # status_change, cert_review, access_query
    description: str
    timestamp: float
...
class RetaliationDetector:
    ...
    Detection layers (from KCC self-healing system):
    1. Pattern matching — correlate member status changes with refusals
    ...
    def check_status_change(self, member_hash: str, refusal: EthicalRefusal,
        ...
        """Check if a member status change correlates with a refusal."""
    ...
    def check_org_pattern(self, org_hash: str,
        ...
        """Check for systemic pattern from one organization."""
...
class RefusalRegister:
    ...
    def file_refusal(self, professional_hash: str, org_hash: str,
        ...
        """File an ethical refusal. Immediate L1 write."""
