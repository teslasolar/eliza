...
Temperatures, pressures, flows, and levels -- the analog measurements that make a factory run. Each tag includes a simulation function for realistic value generation.
