# Tag System Meta-Layer Tags

Tag provider for the tag system itself. Exposes total tag counts, provider counts, and registry health. The tag system monitoring its own tags.
