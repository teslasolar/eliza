...
ACG Guild Platform CLI entry point. Supports simulation mode, file scanning, factory configuration, tag listing, eVGPU benchmarking, and FemtoLLM testing.
