...
Core objects and how they connect. Entities reference UDTs and form hierarchies.

## Enums

Relationship type and cardinality enumerations.
...
A typed, directed relationship between two entities with cardinality.
...
A core object in a standard, typed by a UDT, with hierarchical parent/child relationships and tag-based metadata.
