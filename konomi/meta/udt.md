...
User Defined Types (UDTs) are the building blocks of all standards. Every piece of data in the system is typed via UDTs.

## Field

A field within a UDT, with optional engineering units, range bounds, and validation.
...
A structured data template that collects fields, supports inheritance, and provides validation and instantiation.
