...
Product definition model for ISA-88 batch control. Recipe levels: GeneralRecipe -> SiteRecipe -> MasterRecipe -> ControlRecipe. A Recipe contains a Formula (materials in/out and process parameters) and references a Procedure (the procedural control logic).
