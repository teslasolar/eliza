...
Runtime batch tracking for ISA-88. A Batch ties together a recipe, control recipe, unit allocations, runtime parameters, and an event log that records the full history.
...
## Unit Allocation and Event Logging
...
## Query Properties and Internal Helpers
