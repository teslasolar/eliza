...
Phase, Batch, and PackML/Unit state models built on `konomi.meta.state_machine.StateMachine`. Factory functions return fully configured instances per the ISA-88 standard.
...
The ISA-88 procedural state model with states: IDLE, RUNNING, COMPLETE, HOLDING, HELD, RESTARTING, STOPPING, STOPPED, ABORTING, ABORTED.
...
The ISA-88 batch lifecycle with states: CREATED, SCHEDULED, RUNNING, COMPLETE, HELD, ABORTED.
...
## PackML / Unit State Machine

The ISA-88 / ISA-TR88 unit state machine with 17 states covering normal cycle, hold, suspend, stop, and abort paths.
