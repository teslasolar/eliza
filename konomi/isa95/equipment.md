...
Equipment hierarchy and physical asset model for ISA-95. Hierarchy: Enterprise -> Site -> Area -> WorkCenter -> WorkUnit -> Equipment. Each piece of equipment has a state (operational condition) and a mode (how it is being operated).
