"""
ISA-101 Graphic Elements — reusable display objects, faceplates, and trends.

Elements bind to tag paths (never hard-coded addresses) and inherit
appearance from centralised style definitions.
"""
