"""
ISA-101 Colour Semantics — every colour maps to exactly one process meaning.

All hex values target a neutral-gray (#808080) background for maximum
perceptual contrast during extended operator shifts.
"""
