# L5X Compiler — Assembling Complete PLC Projects

This module is the top-level assembler that combines programs, tasks, tags, and user-defined types into a complete `.L5X` XML file importable by Rockwell Studio 5000. It also provides convenience methods to compile konomi Tag and UDT definitions directly into PLC-ready structures, and to generate common rung patterns like alarm comparisons and multi-condition interlocks.

## L5XProject — The Project Data Container
...
## L5XCompiler — Building Blocks and Konomi Converters
