...
Identifier UDTs -- UUID, PATH, TAG, URN. Every entity in the system gets a unique identifier.

## Utilities and Identifier Class
...
Equipment tag path following ISA naming convention. Format: `Area_Unit_Module_Point` (e.g., `Pkg_Filler_Tank1_Level`).
