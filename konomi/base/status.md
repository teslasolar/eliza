...
Operational status codes and time duration types.

## Status

An operational status with numeric code, name, and severity level.
...
A time duration with unit, supporting conversion between units and arithmetic.
