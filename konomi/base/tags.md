# Base Primitives Tags

Tag provider for the base primitives layer. Exposes system-level value infrastructure: timestamp precision, quality distribution, and active value count.
