...
16d | 1 layer | 1 head | 4MB RAM | 0.1s/req. A real (tiny) transformer, not a mock. Useful for pattern matching, tag classification, and simple rule evaluation within the Konomi system.
