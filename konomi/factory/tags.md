# Factory Simulation Tags

Tag provider for factory hierarchy and simulation. Exposes site/area/line/unit counts, sim engine state, tick counters, and running mode.
