...
Four priority levels from Emergency to Low. Each priority defines response urgency, maximum response time, colour, and audible annunciation pattern.

## AlarmPriority Dataclass
