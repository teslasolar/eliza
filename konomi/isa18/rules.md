...
Rationalization and management constraints. Each rule is an instance of `konomi.meta.rules.Rule` so it can be loaded into a RuleEngine alongside rules from other standards.
