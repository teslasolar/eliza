# ISA-18.2 Alarm and AlarmClass

The core alarm user-defined types. An Alarm is a single configured alarm point. An AlarmClass groups alarms that share priority, sound, and behaviour.
