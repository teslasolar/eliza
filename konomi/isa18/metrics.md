...
KPIs for alarm system health. Provides calculation methods for alarm rate, flood detection, stale alarms, chattering, bad actors, and priority distribution.

## AlarmEvent and Benchmarks
