# Sandbox Registry — Tool Aggregation

Aggregates all sandbox tools and provides a unified MCP-compatible interface.
The registry is the single entry point for tool discovery and invocation.
